...
def triangulate(mtx1, mtx2, R, T):
    ...
    uvs2 = [[146, 112], [150, 268], [249, 342], [288, 341], [250, 379], [288, 379], [417, 384], [362, 228], [470, 228], [373, 330], [457, 330]]
    ...
    '''
    plt.pyplot.imshow(frame1[:,:,[2,1,0]])
    ...
    plt.pyplot.imshow(frame2[:,:,[2,1,0]])
    ...
    RT2 = np.concatenate([R, T], axis = 0)
    P2 = RT2 @ mtx2 #projection matrix for C2
